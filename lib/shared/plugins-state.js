...
PluginsState.prototype.writeGlobalPluginsConfig = function (pluginsConf) {
    return fspromised.writeFile(this._globalPluginsConfigFilepath, JsonConfigsUtils.prettyJsonStringify(pluginsConf));
};
...
PluginsState.prototype.writeGlobalPluginsConfigSync = function (pluginsConf) {
    fs.writeFileSync(this._globalPluginsConfigFilepath, JsonConfigsUtils.prettyJsonStringify(pluginsConf));
};
...
PluginsState.prototype.writePluginConfig = function (pluginName, pluginConf) {
    return fspromised.writeFile(this.getPluginConfPathByName(pluginName), JsonConfigsUtils.prettyJsonStringify(pluginConf));
};
