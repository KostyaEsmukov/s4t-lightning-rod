...
module.exports = function (  // eslint-disable-line max-params
    ...
    return driversState.allocateDriverDirectory(driverName)
        ...
        .spread(function () {
            return driversState.readGlobalDriversConfigItemByName(driverName);
        })
        .then(function (globalDriversConfigItem) {
            globalDriversConfigItem.autostart = autostart;
            globalDriversConfigItem.status = globalDriversConfigItem.STATUSES.INJECTED;

            return driversState.writeGlobalDriversConfigItem(globalDriversConfigItem);
        })
        .then(function () {
            // return void
        });
